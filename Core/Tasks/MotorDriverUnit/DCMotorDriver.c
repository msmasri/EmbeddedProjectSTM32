...
static PWM_BufferType DutyCycle;
...
static void InitPWMMotorDriver(void)
{
	...
	//TODO: should set the value of the pre-scale and auto-compare and autoreload to get 50 Hz
...
static uint32_t ReadEncoderValue(void)
{
