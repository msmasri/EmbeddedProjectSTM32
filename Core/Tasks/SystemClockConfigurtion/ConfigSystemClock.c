...
static void InitSystemClock(void)
{
	...
	RCC->PLLCFGR |= (RCC_PLLCFGR_PLLN_3 | RCC_PLLCFGR_PLLN_5 | RCC_PLLCFGR_PLLN_6
			| RCC_PLLCFGR_PLLN_8);
//	RCC->PLLCFGR &= ~(RCC_PLLCFGR_PLLN_7);

	RCC->PLLCFGR &= ~RCC_PLLCFGR_PLLM; //Reset all old configuration
	RCC->PLLCFGR |= (RCC_PLLCFGR_PLLM_1 | RCC_PLLCFGR_PLLM_3);
...
//	RCC->CFGR |= RCC_CFGR_HPRE_DIV2;
	...
	/* PPRE1 bus AHB clock divided by 4 to get the maximum with 45MHz */
